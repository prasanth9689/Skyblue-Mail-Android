package com.skyblue.mail.interfaces
...
import com.skyblue.mail.MainActivity
import com.skyblue.mail.R
...
//            Spacer(modifier = Modifier.height(20.dp))
            Button(
                ...
                colors = ButtonDefaults.buttonColors(
                    containerColor = if (credentials.isNotEmpty())
...
fun LoginFormPreviewDark() {
    SkyblueMailAndroidTheme(darkTheme = true) {
        LoginForm()
    }
}